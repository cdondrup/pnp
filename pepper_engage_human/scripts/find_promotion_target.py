...
class FindInteractant(object):
    ...
    def execute_cb(self, goal):
        rospy.loginfo("Finding promotion target '%s'" % (goal.interactant_id,))
        ...
        res.result.append(ActionResult(cond="found_promotion__"+goal.interactant_id+"__"+goal.id, truth_value=True))
        res.result.append(ActionResult(cond="free_promotion_id__"+goal.interactant_id, truth_value=False))
...
if __name__ == "__main__":
    rospy.init_node("find_promotion_target")
